...
// BadRequest creates a new API error representing an authentication failure (HTTP 400)
func BadRequest(err error) *APIError {
	return NewAPIError(http.StatusBadRequest, "BAD_REQUEST", Params{"error": err.Error()})
}
